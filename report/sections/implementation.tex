...
This new implementation, titled \textbf{mem-pmod} (MEMory-PowerMODel) is \githublink{open source} and based mainly on C++ plus the support of Python to generate graphics, aims at a better performance and a higher degree of reusability. The final result is able to execute the same operations on the same amount of data in about 50 s, or one fifth of the original amount of time.
